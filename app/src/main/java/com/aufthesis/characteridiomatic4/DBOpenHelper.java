...
{
    static private int DB_VERSION = 8;  //2017/07/09 ver.8
    final static private String DB_NAME = "CharacterIdiom4";
    final static private String DB_NAME_ASSET = "CharacterIdiom4.db";
    final static private String DB_NAME_ZIP = "CharacterIdiom4.zip";
